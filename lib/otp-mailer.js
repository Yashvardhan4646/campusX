...
function buildOtpEmail(otp, purpose) {
  ...
  const subtext =
    purpose === 'signup'
      ...
      : purpose === 'account_delete'
      ? 'Someone (hopefully you) is trying to permanently delete this CampusX account. This action cannot be undone.'
      : isEmailChange
      ? 'Enter this code to verify your new email address on CampusX.'
      ...
      <table width="480" cellpadding="0" cellspacing="0" style="background:#141414;border-radius:16px;border:1px solid #1e1e1e;overflow:hidden;">
        ...
        <tr>
          <td style="background:${headerGradient};padding:28px 32px;text-align:center;">
            <span style="font-size:26px;font-weight:800;color:#fff;letter-spacing:-0.5px;">Campus<span style="color:${isDanger ? '#fecaca' : '#bbf7d0'};">X</span></span>
          </td>
        </tr>
