...
import { Home, GraduationCap, PlusSquare, User, Bell, Bookmark, LogOut, Menu, Search, Calendar, Settings, MessageSquare, Shield, BookOpen, BarChart2, Terminal, Type, History, Heart, Palette, Crown, Zap, Lock, Star, Rocket, ShieldCheck, Smartphone } from "lucide-react"
          ...
          <SheetContent side="right" className="w-70 p-0 flex flex-col">
            ...
            <div className="flex flex-col flex-1 overflow-y-auto">
              ...
              <nav className="p-2 space-y-1">
                ...
                {/* Customize Link */}
                <Link href="/customize" onClick={handleCustomizeClick}>
                  <Button
                    variant="ghost"
                    className={cn(
                      "w-full justify-start gap-4 h-12 px-3",
                      pathname === "/customize" ? "bg-accent text-accent-foreground" : "text-muted-foreground"
                    )}
                  >
                    ...
                    <span className="text-base font-medium">Customize</span>
                  </Button>
                </Link>
